...
def ADT01(url, patientId, unitId, bedId, firstName, lastName, birthDate, gender, timeZone):
    date = getTimeDate(timeZone)
...
def ADT03(url, patientId, unitId, bedId, firstName, lastName, birthDate, gender, timeZone):
    date = getTimeDate(timeZone)
